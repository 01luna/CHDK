...
/*************************************************************/
//** filewritetask @ 0xE03AF92B, length=42 
...
asm volatile (
            ...
            "    b       loc_e03af92e\n"
            "loc_e03af998:\n"
            "    bl      sub_e03afc4c_my\n" // Patched (was sub_e03afc4c)
            "    b       loc_e03af92e\n"
            "loc_e03af99e:\n"
            "    bl      sub_e03af7dc_my\n" // Patched (was sub_e03af7dc)
            "    b       loc_e03af92e\n"
);
}

/*************************************************************/
//** sub_e03af6a4_my @ 0xE03AF6A5, length=126 
void __attribute__((naked,noinline)) sub_e03af6a4_my() {
asm volatile (
...
/*************************************************************/
//** sub_e03afc4c_my @ 0xE03AFC4D, length=64 
void __attribute__((naked,noinline)) sub_e03afc4c_my() {
asm volatile (
            ...
            "    mov     r2, r1\n"
            "    mov     r1, r7\n"
            "    bl      fwt_write\n" // j_Write_FW // Patched (was sub_e037404a)
            "    ldr     r1, [r5, #4]\n"
            "    cmp     r8, r0\n"
            "    add     r1, r0\n"
            "    str     r1, [r5, #4]\n"
...
/*************************************************************/
//** sub_e03af7dc_my @ 0xE03AF7DD, length=140 
void __attribute__((naked,noinline)) sub_e03af7dc_my() {
asm volatile (
            "    push    {r4, r5, r6, r7, lr}\n"
            "    mov     r4, r0\n"
            "    ldr     r0, [r0, #0x50]\n"
