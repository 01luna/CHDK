...
/*************************************************************/
//** filewritetask @ 0xFF3AF558 - 0xFF3AF698, length=81
...
"    CMP     R0, #0 \n"
"    LDRNE   R2, =0x476 \n"
"    LDRNE   R1, =0xFF3AF6CC /*'dwFWrite.c'*/ \n"
"    MOVNE   R0, #0 \n"
"    BLNE    _DebugAssert \n"
#ifdef FILEWRITE_DEBUG_LOG
"ldr     r0, [sp,#8]\n"
...
"loc_FF3AF64C:\n"
"    BL      sub_FF3AF180_my \n"  // --> Patched. Old value = 0xFF3AF180. msg 12 - open, main hook
"    B       loc_FF3AF560 \n"
...
"loc_FF3AF68C:\n"
"    BL      sub_FF3AFA28_my \n"  // --> Patched. Old value = 0xFF3AFA28. msg 0-6 - write chunk
"    B       loc_FF3AF560 \n"

"loc_FF3AF694:\n"
"    BL      sub_FF3AF358_my \n"  // --> Patched. Old value = 0xFF3AF358. msg 0-7 - close
"    B       loc_FF3AF560 \n"
);
}

/*************************************************************/
//** sub_FF3AF180_my @ 0xFF3AF180 - 0xFF3AF354, length=118
void __attribute__((naked,noinline)) sub_FF3AF180_my() {
asm volatile (
"    STMFD   SP!, {R4-R9,LR} \n"
"    MOV     R4, R0 \n"
...
/*************************************************************/
//** sub_FF3AFA28_my @ 0xFF3AFA28 - 0xFF3AFB0C, length=58
void __attribute__((naked,noinline)) sub_FF3AFA28_my() {
asm volatile (
"    STMFD   SP!, {R4-R10,LR} \n"
"    MOV     R5, R0 \n"
"    LDR     R0, [R0] \n"
...
"    CMP     R4, R7 \n"
"    LDRCS   R2, =0x3DF \n"
"    LDRCS   R1, =0xFF3AF6CC /*'dwFWrite.c'*/ \n"
"    ADD     R8, R8, R0 \n"
"    MOVCS   R0, #0 \n"
"    BLCS    _DebugAssert \n"
"    CMP     R4, #0 \n"
...
/*************************************************************/
//** sub_FF3AF358_my @ 0xFF3AF358 - 0xFF3AF3EC, length=38
void __attribute__((naked,noinline)) sub_FF3AF358_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R4, R0 \n"
"    LDR     R0, [R0, #0x50] \n"
