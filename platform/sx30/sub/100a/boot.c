...
/*************************************************************/
//** taskcreate_Startup_my @ 0xFF81FB54 - 0xFF81FBBC, length=27
...
"    MOV     R0, #0 \n"
"    BL      sub_FF83AEDC \n"
"    BL      sub_FF83AC88 /*_EnableDispatch*/ \n"
"    MOV     R3, #0 \n"
"    STR     R3, [SP] \n"
...
/*************************************************************/
//** taskcreatePhySw_my @ 0xFF83461C - 0xFF83463C, length=9
...
/*************************************************************/
//** init_file_modules_task @ 0xFF8A3B24 - 0xFF8A3B40, length=8
...
/*************************************************************/
//** sub_FF89A298_my @ 0xFF89A298 - 0xFF89A2A0, length=3
void __attribute__((naked,noinline)) sub_FF89A298_my() {
asm volatile (
"    STMFD   SP!, {R4,LR} \n"
"    MOV     R0, #3 \n"
...
/*************************************************************/
//** sub_FF876E1C_my @ 0xFF876E1C - 0xFF876E70, length=22
...
/*************************************************************/
//** sub_FF876A44_my @ 0xFF876A44 - 0xFF876A6C, length=11
...
/*************************************************************/
//** sub_FF876764_my @ 0xFF876764 - 0xFF8768D4, length=93
...
/*************************************************************/
//** JogDial_task_my @ 0xFF865D08 - 0xFF866030, length=203
...
"    CMP     R0, #0 \n"
"    LDRNE   R1, =0x262 \n"
"    LDRNE   R0, =0xFF865FC4 /*'RotaryEncoder.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP] \n"
"    AND     R4, R0, #0xFF \n"
"    AND     R0, R0, #0xFF00 \n"
...
"    LDR     R7, =0x2594 \n"
"    LDR     R0, [R7, R4, LSL#2] \n"
"    BL      sub_FF83B460 /*_CancelTimer*/ \n"
"    LDR     R2, =0xFF865C54 \n"
"    MOV     R1, R2 \n"
"    ORR     R3, R4, #0x200 \n"
"    MOV     R0, #0x28 \n"
"    BL      sub_FF83B37C /*_SetTimerAfter*/ \n"
"    TST     R0, #1 \n"
"    CMPNE   R0, #0x15 \n"
"    STR     R0, [R10, R4, LSL#2] \n"
"    BEQ     loc_FF865D64 \n"
...
"loc_FF865F64:\n"
"    LDR     R0, =0xFF865FC4 /*'RotaryEncoder.c'*/ \n"
"    BL      _DebugAssert \n"
...
"    CMP     R0, #0 \n"
"    MOVEQ   R1, #0x2E0 \n"
"    LDREQ   R0, =0xFF865FC4 /*'RotaryEncoder.c'*/ \n"
"    BLEQ    _DebugAssert \n"
"    RSB     R0, R4, R4, LSL#3 \n"
"    ADD     R0, R6, R0, LSL#2 \n"
"    LDR     R0, [R0, #0xC] \n"
